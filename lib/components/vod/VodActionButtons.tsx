        ...
        {isComingSoon ? (
          ...
          >
            <button
              ...
              className={`inline-flex items-center justify-center w-[146px] md:w-[150px] xl:w-[171px] font-[500] gap-[8px] rounded-[40px] bg-linear-to-r from-portland-orange to-lust hover:to-portland-orange ease-out duration-300 cursor-pointer ${
                type !== 'hovered-slide'
