  ...
  return (
    <ModalWrapper
      ...
      overlayClassName={`
        ...
        ${
          isLandscape
            ? 'flex justify-center items-start pt-16 pb-4 overflow-y-auto'
            : 'flex justify-center items-center p-4'
        }
      `}
    >
      {/* Landscape: 596x587, Mobile: 343x454, Tablet/PC: 568x578 */}
      <div
        className={`
          flex flex-col justify-center items-center gap-4
          ${
            isLandscape
              ? 'p-6 gap-4 w-[596px] min-h-[587px]'
              : isMobile
              ? 'p-4 gap-8'
              : 'p-8 gap-8'
          }
      ...
      >
        ...
        >
          ...
          <h2
            className={`
              text-white-smoke font-semibold leading-[130%] tracking-[0.02em] text-center
          ...
          <p
            className={`
              text-spanish-gray font-normal text-[16px] leading-[130%] tracking-[0.02em] text-center w-full
            ...
            {!activePackages || activePackages.length === 0 ? (
              ...
              <div className="flex-1">
                {activePackages && activePackages.length > 0 ? (
                  <div
                    className={`
                      rounded-[12px] bg-white-007 p-4 text-silver-chalice relative
                      ${styles.servicesContainer}
                      ${
                        activePackages.length > 1
                          ? `min-h-[79px] overflow-y-auto ${styles.scrollBar}
                           ${
                             isLandscape
                               ? 'max-h-[265px]'
                               : 'max-h-[calc(40vh-145px)] tablet:max-h-[208px]'
                           }`
                          : ''
                      }
                    `}
        ...
        >
          <button
            ...
            className={`
              cursor-pointer flex flex-row justify-center items-center gap-2 w-full
              ${
                isLandscape
                  ? 'px-4 py-2 h-[40px]'
                  : 'px-4 tablet:px-6 py-2 tablet:py-3 h-[40px] tablet:h-[47px]'
              }
              bg-gradient-to-r from-portland-orange to-lust rounded-[40px] 
              text-white-smoke font-semibold text-[16px] leading-[130%] tracking-[0.02em]
