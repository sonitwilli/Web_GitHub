...
const AutoNextVideo: React.FC<AutoNextVideoProps> = ({ isExpanded }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex flex-col xl:flex-row xl:items-end xl:justify-between items-start gap-4 tablet:gap-6 xl:gap-8 absolute bottom-[20px] tablet:bottom-[42px] xl:bottom-[40px] ${
          isExpanded
